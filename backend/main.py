...
from app.api import user_routes, show_routes, episode_routes, auth_routes, episode_live_routes, episode_recording_routes, websocket_routes, streaming_routes
...
def get_application():
    ...
    _app.include_router(streaming_routes.router)
